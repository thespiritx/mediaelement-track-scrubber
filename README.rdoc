...
How to use (as a dev):
Add this gem to your gemfile (mediaelement-track-scrubber)
bundle install
add the styling assets to your manifest file: *= require me-track-scrubber
add the javascript assets to your manifest file: //= require me-track-scrubber

You'll need to make changes to a few files too.
...
line 108: $(@player.media).on 'timeupdate', =>
            @setActiveSection()
111:        @player.updateTrackScrubber()
...
124:      @player.showTrackScrubber(true)
...
169:      @player.showTrackScrubber(true)
